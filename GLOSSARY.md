...
# Должность
Совокупность обязанностей, инструментов и вознаграждений предназначенных одному человеку.
...
Справочник, который поставляется вместе с ПО и не доступный для редактирования пользователям, содержит одинаковые данные на всех базах.

# ТМ
Торговая Марка.

# ЭСС
Элемент структуры сторчека.

# ГСС
Группировка структуры сторчека.

# Доля полки в категории
Соотношение количества SKU, принадлежащих одной ЭСС и ГСС, на полке РТТ к общему количеству SKU, принадлежащих этой же ГСС на полке РТТ.
