...
В этой таблице как уже описывалось выше, пользователю необходимо заполнять только **БЦП** и присвоить ГЦО каждому товару, все остальные данные будут заполнены автоматически. По сути это и есть прайс-лист дистрибьютора. Если же по каким-то причинам пользователь неправильно расценит
