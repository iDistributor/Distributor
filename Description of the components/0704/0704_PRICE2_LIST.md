...
- **Тип цены для сотрудника** - задается по какой категории отпускной цены будет отпускаться товар сотрудникам компании. Этот параметр используется при формировании документа **РН СОТ** в компоненте **2220 ЖД Накладная на сотрудника**
