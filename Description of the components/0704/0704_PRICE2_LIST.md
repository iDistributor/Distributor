...
Документ прайс-лист может создаваться и редактироваться на  **филиале с признаком ЦО**. В случае филиальной структуры, происходит дальнейшая синхронизация документа на филиалы. Важно понимать, что по одному **производителю** в один период времени, на одном филиале может существовать только один
...
- Список доступных ГЦО для каждого производителя свой и настраивается в справочнике **1111 СПР Производители**. Группы ценообразования (**ГЦО**) добавляются и удаляются в  самом документе,в других прайс-листах этого производителя набор **ГЦО** при этом не изменится. Таким образом каждый прайс-лист имеет свой набор **ГЦО**. Создавая новый прайс-лист пользователю необязательно задействовать все возможные ГЦО данного производителя, скорее наоборот их количество должно быть минимально достаточным для описания условий расчета цен.

![рис.2](./media/0704_3.gif "рис.2")
   *рис.2*
...
В этой таблице как уже описывалось выше, пользователю необходимо заполнить только **БЦП** и присвоить ГЦО каждому товару, все остальные данные будут заполнены автоматически. По сути это и есть прайс-лист дистрибьютора.

![рис.4](./media/0704_4.gif "рис.4")  
*рис.4*

Если же по каким-то причинам пользователь неправильно расценит
...
![рис.6](./media/image5.png "Диаграмма связей цен")  
*рис.6*
