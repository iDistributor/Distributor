...
- Аналогично настраиваются и общесистемные настройки (**Ctrl+F2**), отличие в том что в общесистемных настраиваются параметры, влияющие на работу нескольких компонентов.
