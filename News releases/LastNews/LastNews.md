...
**Доработки отчета:** Для Конечного потребителя в соответствии с порядком заполнения Код ОКПО заполняется «КП».
В ПФ Отчета сортировка данных по Поставщикам в порядке возрастания значения кода ОКПОЕГР/ИНН.
...
- Исправлена ошибка, из-за которой в форме подбора ТМЦ и в таблице с ТМЦ пропали коды внешних систем ТТН/РН и ПН/АПОХ/АВОХ

-------------
## Админинистративная консоль
*Системные администраторы*
- Присвоены номера всем компонентам в настройках справочников. 
